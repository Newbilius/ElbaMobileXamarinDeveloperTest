...
Написать мобильное приложение, которое отображет список контактов и выполняет поиск по ним. Приложение должно быть написано на Xamarin одновременно для iOS и Android. Можно использовать как Xamarin.Forms, так и нативную вёрстку. Решенное задание выложить на github/gitlab.
